...
plate_path = 'D:\soft\python_project\lenet\img_1.png'
root_path = 'D:\soft\python_project\lenet'
MIN_PALAT_AREA = 6000
...
# ● sigmaY是卷积核在垂直方向上（Y轴方向）的标准差。如果将该值设置为0，则只采用sigmaX的值
    ...
    # # 二值化处理
    # thresh = cv2.threshold(edge, 0, 255, cv2.THRESH_OTSU)[1]
